...
{
    public class AsesoriasEntrenadoresController : Controller
    {
        // GET: AsesoriasEntrenadores
        public ActionResult Index()
        {
            return View();
        }
        public ActionResult ListaAsesoriasEntrenadores()
        {
            return View();
        }
        ...
        public struct ObjAsesoriasEntrenadores
        {
            public AsesoriasEntrenadores AsesoriasEntrenadoresDeport { get; set; }
        ...
        [HttpGet]
        public JsonResult GetListAsesoriasEntrenadores()
        {
            ...
            {
                var AsesoriasEntrenadoresExiste = db.AsesoriasEntrenadores.ToList().OrderByDescending(o => o.IdAsesoriasEntrenadores);

                foreach (var item in AsesoriasEntrenadoresExiste)
                {



                }
                ret.objeto = new { DepoListResul = AsesoriasEntrenadoresExiste };
        ...
        [HttpGet]
        public JsonResult GetAsesoriasEntrenadoresById(int IdAsesoriasEntrenadoresDepor)
        {
            Respuesta ret = new Respuesta();
            using (Models.BIOMEDICOEntities5 db = new Models.BIOMEDICOEntities5())

            {
                var AsesoriasentrenadoresUpdate = db.AsesoriasEntrenadores.FirstOrDefault(w => w.IdAsesoriasEntrenadores == IdAsesoriasEntrenadoresDepor);


                ret.objeto = AsesoriasentrenadoresUpdate;
        ...
        public JsonResult Agregar(ObjAsesoriasEntrenadores a)
        {
            ...
            try
            {
...

                {
                    ...
                    a.AsesoriasEntrenadoresDeport.FechaRegistro = DateTime.Now;
                    a.AsesoriasEntrenadoresDeport.UsuarioRegistra = Utilidades.ActiveUser.NomUsuario;
                    ...
                    db.AsesoriasEntrenadores.Add(a.AsesoriasEntrenadoresDeport);
                    db.SaveChanges();
                    var Id = a.AsesoriasEntrenadoresDeport.IdAsesoriasEntrenadores;
