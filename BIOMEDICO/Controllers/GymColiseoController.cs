...
{
    public class GymColiseoController : Controller
    {
        // GET: GymColiseo
        ...
        public ActionResult ListaGymColiseo()
        {
            return View();
        }
        ...
        public struct ObjPlanPlanGymColiseo
        {
            public GymColiseo GymColiseoDeport { get; set; }
        ...
        [HttpGet]
        public JsonResult GetListGymColiseo()
        {
            ...
            {
                var PlanGymColiseo = db.GymColiseo.ToList().OrderByDescending(o => o.IdGymColiseo);

                foreach (var item in PlanGymColiseo)
                {



                }
                ret.objeto = new { DepoListResul = PlanGymColiseo };
        ...
        [HttpGet]
        public JsonResult GetPlanPlanGymColiseoById(int IdGymColiseo)
        {
            Respuesta ret = new Respuesta();
            using (Models.BIOMEDICOEntities5 db = new Models.BIOMEDICOEntities5())

            {
                var PlanIdGymColiseoUpdate = db.GymColiseo.FirstOrDefault(w => w.IdGymColiseo == IdGymColiseo);


                ret.objeto = PlanIdGymColiseoUpdate;
        ...
        public JsonResult Agregar(ObjPlanPlanGymColiseo a)
        {
            ...
            try
            {
...

                {
                    ...
                    a.GymColiseoDeport.FechaRegistro = DateTime.Now;
                    a.GymColiseoDeport.UsuarioRegistro = Utilidades.ActiveUser.NomUsuario;
                    ...
                    db.GymColiseo.Add(a.GymColiseoDeport);
                    db.SaveChanges();
                    var Id = a.GymColiseoDeport.IdGymColiseo;
