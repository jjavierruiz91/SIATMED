...
{
    public class GymEstadioController : Controller
    {
        // GET: GymEstadio
        ...
        public ActionResult ListaGymEstadio()
        {
            return View();
        }
        ...
        public struct ObjPlanGymEstadio
        {
            public GymEstadio GymEstadioDeport { get; set; }
        ...
        [HttpGet]
        public JsonResult GetListGymEstadio()
        {
            ...
            {
                var PlanGymEstadio = db.GymEstadio.ToList().OrderByDescending(o => o.IdGymEstadio);

                foreach (var item in PlanGymEstadio)
                {



                }
                ret.objeto = new { DepoListResul = PlanGymEstadio };
        ...
        [HttpGet]
        public JsonResult GetPlanGymEstadioById(int IdGymEstadio)
        {
            Respuesta ret = new Respuesta();
            using (Models.BIOMEDICOEntities5 db = new Models.BIOMEDICOEntities5())

            {
                var PlanGymEstadiUpdate = db.GymEstadio.FirstOrDefault(w => w.IdGymEstadio == IdGymEstadio);


                ret.objeto = PlanGymEstadiUpdate;
        ...
        public JsonResult Agregar(ObjPlanGymEstadio a)
        {
            ...
            try
            {
...

                {
                    ...
                    a.GymEstadioDeport.FechaRegistro = DateTime.Now;
                    a.GymEstadioDeport.UsuarioRegistro = Utilidades.ActiveUser.NomUsuario;
                    ...
                    db.GymEstadio.Add(a.GymEstadioDeport);
                    db.SaveChanges();
                    var Id = a.GymEstadioDeport.IdGymEstadio;
