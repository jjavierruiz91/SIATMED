...
{
    public class HorarioEntrenadoresController : Controller
    {
        // GET: HorarioEntrenadores
        public ActionResult Index()
        {
            return View();
        }
        public ActionResult ListaHorarioEntrenadores()
        {
            return View();
        }
        ...
        public struct ObjHorarioEntrenadores
        {
            public HorarioEntrenadores HorarioEntrenadoresDeport { get; set; }
        ...
        [HttpGet]
        public JsonResult GetListHorarioEntrenadores()
        {
            ...
            {
                var PlanHorarioEntrenadores = db.HorarioEntrenadores.ToList().OrderByDescending(o => o.IdHorarioEntrenadores);

                foreach (var item in PlanHorarioEntrenadores)
                {



                }
                ret.objeto = new { DepoListResul = PlanHorarioEntrenadores };
        ...
        [HttpGet]
        public JsonResult GetPlanPlanHorarioEntrenadoresById(int IdHorarioEntrenadores)
        {
            Respuesta ret = new Respuesta();
            using (Models.BIOMEDICOEntities5 db = new Models.BIOMEDICOEntities5())

            {
                var PlanHorarioEntrenadoresUpdate = db.GymEstadio.FirstOrDefault(w => w.IdGymEstadio == IdHorarioEntrenadores);


                ret.objeto = PlanHorarioEntrenadoresUpdate;
        ...
        public JsonResult Agregar(ObjHorarioEntrenadores a)
        {
            ...
            try
            {
...

                {
                    ...
                    a.HorarioEntrenadoresDeport.FechaRegistro = DateTime.Now;
                    a.HorarioEntrenadoresDeport.UsuarioRegistra = Utilidades.ActiveUser.NomUsuario;
                    ...
                    db.HorarioEntrenadores.Add(a.HorarioEntrenadoresDeport);
                    db.SaveChanges();
                    var Id = a.HorarioEntrenadoresDeport.IdHorarioEntrenadores;
